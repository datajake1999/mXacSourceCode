...
class DLLEXPORT CProgress : public CProgressSocket, public CEscObject {
public:
   CProgress (void);
   ~CProgress (void);
...
class DLLEXPORT CMatrix : public CEscObject {
public:
   fp      p[4][4];
...
class DLLEXPORT CObjectSurface : public CEscObject {
public:
   CObjectSurface (void);
...
class CPoint;
class DLLEXPORT CImage : public CEscObject {
private:
...
class CPoint;
class DLLEXPORT CZImage : public CEscObject {
private:
...
class DLLEXPORT CFImage : public CEscObject {
private:
...
class DLLEXPORT CRenderMatrix : public CEscObject {
public:
   CRenderMatrix (void);
   ~CRenderMatrix (void);
   void ClearAll (void);
...
class DLLEXPORT CImageShader : public CEscObject {
private:
...
class DLLEXPORT CSpline : public CEscObject {
public:
   CSpline (void);
   ~CSpline (void);
...
class DLLEXPORT CMeshGrid : public CEscObject {
public:
   CMeshGrid (void);
   ~CMeshGrid (void);
...
class DLLEXPORT CSplineSurface : public CEscObject {
public:
   CSplineSurface (void);
   ~CSplineSurface (void);
...
DLLEXPORT BOOL DefaultSurfFromNewTexture (GUID *pgCode, GUID *pgSub, PCObjectSurface pSurf);
...
DLLEXPORT BOOL TextureLibraryDialog (HWND hWnd);
class CWorldSocket;
typedef CWorldSocket *PCWorldSocket;
DLLEXPORT PCMMLNode2 TextureCacheUserTextures (PCWorldSocket pWorld);
class CLibrary;
DLLEXPORT BOOL TextureUnCacheUserTextures (PCMMLNode2 pNode, HWND hWnd, CLibrary *pLibrary);



// CSurfaceScheme - This object stores all a color/texture scheme up for a world
class CWorldSocket;
class DLLEXPORT CSurfaceScheme : public CSurfaceSchemeSocket, public CEscObject {
public:
   CSurfaceScheme (void);
   ~CSurfaceScheme (void);
...
typedef struct {
   GUID           gClassCode; // Class-ID that can find the right piece of code for the object
   GUID           gClassSub;  // class-ID, which when passed to the class-factor pointed to by
...
class DLLEXPORT CObjectTemplate : public CObjectSocket, public CEscObject, private CRenderSocket {
public:
...
class DLLEXPORT CRenderSurface : public CEscObject {
public:
   CRenderSurface (void);
   ~CRenderSurface (void);
   ...
   void SetDefMaterial (PCObjectSurface pos, PCWorldSocket pWorld);      // set material based on object surface
...
class CNoodle;
class DLLEXPORT CBalustrade : public CEscObject {
public:
   CBalustrade (void);
   ~CBalustrade (void);

   BOOL InitButDontCreate (DWORD dwType, PCObjectTemplate pTemplate);
   BOOL Init (DWORD dwType, PCObjectTemplate pTemplate, PCSpline pBottom, PCSpline pTop, BOOL fIndent);
   BOOL NewSplines (PCSpline pBottom, PCSpline pTop);
   PCMMLNode2 MMLTo (void);
   BOOL MMLFrom (PCMMLNode2 pNode);
   CBalustrade *Clone (void);
   void Render (POBJECTRENDER pr, CRenderSurface *prs);
   void QueryBoundingBox (PCPoint pCorner1, PCPoint pCorner2);
...
class DLLEXPORT CPiers : public CEscObject{
public:
   CPiers (void);
   ~CPiers (void);
...
//private:
   ...
   void ClaimAllNecessaryColors (void);
   BOOL GenerateIntersect (void);
   void UpdateSkirting (fp fHeight);
...
class DLLEXPORT CDoubleSurface : public CEscObject {
public:
   CDoubleSurface (void);
   ~CDoubleSurface (void);
...
/********************************************************************************
CSingleSurface */
class DLLEXPORT CSingleSurface : public CEscObject {
public:
   CSingleSurface (void);
   ~CSingleSurface (void);
...
class DLLEXPORT CTooth : public CEscObject {
public:
   CTooth (void);
   ~CTooth (void);
...
class DLLEXPORT CHairLock : public CEscObject {
public:
   CHairLock (void);
   ~CHairLock (void);
...
class DLLEXPORT CPMVert : public CEscObject {
public:
   CPMVert (void);
...
class DLLEXPORT CPMSide : public CEscObject {
public:
...
class DLLEXPORT CPMEdge : public CEscObject {
public:
   CPMEdge (void);
...
class DLLEXPORT CPolyMesh : public CEscObject {
public:
...
class DLLEXPORT COEAttrib : public CEscObject {
public:
   COEAttrib (void);
   ~COEAttrib (void);
...
BOOL ObjEditReloadCache (GUID *pgCode, GUID *pgSub);

class CObjectEditor;
typedef CObjectEditor *PCObjectEditor;

class DLLEXPORT COERemap : public CRenderSocket, CEscObject {
public:
   COERemap (void);
   ~COERemap (void);
...
class DLLEXPORT CSSRemap : public CSurfaceSchemeSocket, CEscObject {
public:
   CSSRemap (void);
   ~CSSRemap (void);
...
class DLLEXPORT CWorld : public CWorldSocket, public CEscObject {
...
class DLLEXPORT CRenderClip : public CEscObject {
public:
   CRenderClip (void);
   ~CRenderClip (void);
...
class CRayObject : public CEscObject {
   friend class CRenderTraditional;

public:
   CRayObject (PCRenderRay pRenderRay, PCRenderTraditional pRenderTrad, BOOL fIsClone);
   ~CRayObject (void);
...
class DLLEXPORT CRenderRay : public CRenderSuper, public CRenderSocket, public CEscObject,
   public CViewSocket {
public:
   // from CRenderSuper
...
#define RTTHREADSCALE            2           // create twice as many threads as processors
...
class DLLEXPORT CRenderTraditional : public CRenderSuper, public CRenderSocket, public CEscObject {
...
private:
   ...
   DWORD MultiThreadedClaimBuf (void);
   ...
   // multithreaded
   DWORD          m_dwThreads;         // number of extra threads created, or 0 if all in one thread
...
class DLLEXPORT CNoodle : public CEscObject {
public:
   CNoodle (void);
   ~CNoodle (void);
...
class DLLEXPORT CRevolution : public CEscObject {
public:
   CRevolution(void);
   ~CRevolution(void);
...
class DLLEXPORT CColumn : public CEscObject {
public:
   CColumn (void);
   ~CColumn (void);
...
/***********************************************************************************
CToolTip */
class DLLEXPORT CToolTip : public CEscObject {
...
class DLLEXPORT CIconButton : public CEscObject {
...
/***********************************************************************************
CButtonBar */
class DLLEXPORT CButtonBar : public CEscObject {
public:
   CButtonBar(void);
   ~CButtonBar(void);
...
class DLLEXPORT CHouseView : public CViewSocket, public CEscObject {
...
public:
   ...
   CRenderTraditional m_aRender[VIEWTHUMB];  // rendering object
...
DLLEXPORT void MakeWindowText (char *psz);
DLLEXPORT void SetViewTitles (void);
DLLEXPORT void CloseAllViewsDown (void);
DLLEXPORT BOOL FileSave (char *pszFile);
...
DLLEXPORT BOOL M3DInit (BOOL fLibraryAppDir, PCProgressSocket pProgress);
DLLEXPORT BOOL M3DEnd (PCProgressSocket pProgress);
DLLEXPORT BOOL M3DFileOpen (PWSTR pszFile, BOOL *pfFailedToLoad, PCProgressSocket pProgress,
                            BOOL fViewLoad = TRUE, PCRenderTraditional *ppRender = NULL);
class CLibrary;
DLLEXPORT BOOL M3DFileOpenRemoveUser (PWSTR pszFileSource, PCMegaFile pmfDest,
                            PWSTR pszFileDest, CLibrary * pLibraryUserClone);
DLLEXPORT void M3DFileNew (BOOL fCreateGroundSky = TRUE);
DLLEXPORT PCWorld M3DWorldSwapOut (PCSceneSet* ppScene);
...
DLLEXPORT PCWorldSocket WorldGet (PCSceneSet *ppScene = NULL);
DLLEXPORT COLORREF MapColorPicker (DWORD dwIndex);
DLLEXPORT void M3DLibraryDir (char *psz, DWORD dwLen);
DLLEXPORT void WorldSet (PCWorldSocket pWorld, PCSceneSet pScene);
...
DLLEXPORT int VistaThreadPriorityHack (int iPriority);
...
DLLEXPORT PCObjectSocket MMLToObject (PCMMLNode2 pNode);
...
DLLEXPORT void ObjPaintDialog (DWORD dwID, PCObjectSocket pos, PCHouseView pView, BOOL fNoUI);
DLLEXPORT BOOL TextureCacheRelease (PCTextureMapSocket pTexture);
DLLEXPORT void TextureCacheDelete (const GUID *pgCode, const GUID *pgSub, BOOL fReallyDelete = TRUE);
DLLEXPORT PCTextureMapSocket TextureCacheGet (PRENDERSURFACE pRS, QWORD *pqwTextureCacheTimeStamp, PCTextureMapSocket pTextureMapLast);
DLLEXPORT PCTextureMapSocket TextureCacheGetDynamic (GUID *pgCode, GUID *pgSub, QWORD *pqwTextureCacheTimeStamp, PCTextureMapSocket pTextureMapLast);
DLLEXPORT void TextureCacheAddDynamic (PCTextureMapSocket pAdd);
DLLEXPORT void TextureCacheClear (DWORD dwMax);
DLLEXPORT DWORD TextureCacheNum (void);
DLLEXPORT void TextureCacheEnd (PCProgressSocket pProgress);
DLLEXPORT void TextureCacheInit (PCProgressSocket pProgress);
DLLEXPORT PCTextureMapSocket TextureCreate (const GUID *pCode, const GUID *pSub);
DLLEXPORT BOOL TextureNameFromGUIDs (GUID *pgCode, GUID *pgSub,PWSTR pszMajor, PWSTR pszMinor, PWSTR pszName);
DLLEXPORT BOOL TextureGUIDsFromName (PWSTR pszMajor, PWSTR pszMinor, PWSTR pszName, GUID *pgCode, GUID *pgSub);
DLLEXPORT void TextureEnumItems (PCListFixed pl, PWSTR pszMajor, PWSTR pszMinor);
DLLEXPORT void TextureEnumMinor (PCListFixed pl, PWSTR pszMajor);
DLLEXPORT void TextureEnumMajor (PCListFixed pl);
DLLEXPORT BOOL TextureSelDialog (HWND hWnd, PCObjectSurface pSurf, PCWorldSocket pWorld);
DLLEXPORT void TextureRebuildTextureColorList (void);
...
DLLEXPORT HBITMAP TextureGetThumbnail (GUID *pgCode, GUID *pgSub, HWND hWnd, COLORREF *pcTransparent);
DLLEXPORT BOOL TextureDetailSet (int iDetail);
DLLEXPORT int TextureDetailGet (void);
...
BOOL TextureAlgoUnCache (const GUID *pgCode, const GUID *pgSub,
...
BOOL TextureAlgoCache (const GUID *pgCode, const GUID *pgSub, PCImage pImage, PCImage pImage2,
                       PCMaterial pMaterial, PTEXTINFO pti);
BOOL TextureAlgoTextureQuery (PCListFixed plText, PCBTree pTree, GUID *pagThis);
BOOL TextureAlgoSubTextureNoRecurse (PCListFixed plText, GUID *pagThis);
...
class DLLEXPORT CTextureMap : public CTextureMapSocket, public CEscMultiThreaded, public CEscObject {
public:
   CTextureMap (void);
   ~CTextureMap (void);
...
public:
   CTextCreatorImageFile (DWORD dwType);
   virtual void Delete (void);
   virtual BOOL MMLFrom (PCMMLNode2 pNode);
   virtual PCMMLNode2 MMLTo (void);
...
PCTextCreatorSocket CreateTextureCreator (const GUID *pgMajor, DWORD dwType, PCMMLNode2 pNode,
                                          BOOL fCanCreateVol);

/********************************************************************************
VolText */
class DLLEXPORT CTextureVolSocket : public CTextureMapSocket, public CTextCreatorSocket, public CEscObject {
public:
   CTextureVolSocket (void);
   ~CTextureVolSocket (void);

   // ALWAYS OVERRIDDENT - SPECIFIC TO THIS
   virtual BOOL Init (const GUID *pCode, const GUID *pSub, PCMMLNode2 pNode);
...
DLLEXPORT PCTextureMapSocket TextureCreateVol (const GUID *pCode, const GUID *pSub);
DLLEXPORT PCTextureVolSocket TextureCreateVol (const GUID *pCode);

/********************************************************************************
CTextureImage */

class DLLEXPORT CTextureImage : public CEscObject {
public:
   CTextureImage (void);
   ~CTextureImage (void);

   BOOL FromTexture (const GUID *pgCode, const GUID *pgSub);
   BOOL ToTexture (void);
...
DLLEXPORT BOOL ObjectCFNameFromGUIDs (GUID *pgCode, GUID *pgSub,PWSTR pszMajor, PWSTR pszMinor, PWSTR pszName);
DLLEXPORT BOOL ObjectCFGUIDsFromName (PWSTR pszMajor, PWSTR pszMinor, PWSTR pszName, GUID *pgCode, GUID *pgSub);
...
DLLEXPORT void ObjectCFEnumItems (PCListFixed pl, PWSTR pszMajor, PWSTR pszMinor);
DLLEXPORT void ObjectCFEnumMinor (PCListFixed pl, PWSTR pszMajor);
DLLEXPORT void ObjectCFEnumMajor (PCListFixed pl);
DLLEXPORT PCObjectSocket ObjectCFCreate (const GUID *pCode, const GUID *pSub);
DLLEXPORT BOOL ObjectCFNewDialog (HWND hWnd, GUID *pgCode, GUID *pgSub);
DLLEXPORT void HackObjectsCreate (void);
DLLEXPORT BOOL ObjectLibraryDialog (HWND hWnd);
DLLEXPORT BOOL ObjectEditorSave (PVIEWOBJ pvo);
DLLEXPORT PCMMLNode2 ObjectCacheUserObjects (PCWorldSocket pWorld);
DLLEXPORT BOOL ObjectUnCacheUserObjects (PCMMLNode2 pNode, HWND hWnd, CLibrary *pLibrary);
DLLEXPORT HBITMAP Thumbnail (GUID *pgMajor, GUID *pgMinor, HWND hWnd, COLORREF *pcrBackground);
BOOL ObjectEditorShowWindow (GUID *pgCode, GUID *pgSub);
...
class DLLEXPORT CDoorFrame : public CEscObject {
public:
   CDoorFrame (void);
   ~CDoorFrame (void);
...
class DLLEXPORT CDoor : public CEscObject {
...
class DLLEXPORT CDoorSet : public CEscObject {
public:
   CDoorSet (void);
   ~CDoorSet (void);
...
class DLLEXPORT CDoorOpening : public CEscObject {
public:
   CDoorOpening (void);
   ~CDoorOpening (void);
...
class DLLEXPORT CShadowBuf : public CEscObject {
public:
   CShadowBuf (void);
   ~CShadowBuf (void);
...
class DLLEXPORT CLight : public CEscObject {
public:
   CLight (void);
   ~CLight (void);
...
class DLLEXPORT CLibraryCategory : public CEscObject {
...
class DLLEXPORT CLibrary : public CEscObject {
...
extern CLibrary gLibraryInstalled;    // installed library
extern CLibrary gLibraryUser;         // user library
extern PCLibraryCategory gpLCTexturesInstalled;  // custom textures
extern PCLibraryCategory gpLCTexturesUser;
extern PCLibraryCategory gpLCObjectsInstalled;   // custom objects
extern PCLibraryCategory gpLCObjectsUser;
...
DLLEXPORT void LibraryOpenFiles (BOOL fAppDir, PCProgressSocket pProgress);
DLLEXPORT void LibrarySaveFiles (BOOL fAppDir, PCProgressSocket pProgress, BOOL fSkipInstalled = FALSE);
DLLEXPORT void LibraryCombineLists (PCListFixed lA, PCListFixed lB);
DLLEXPORT PCLibraryCategory LibraryTextures (BOOL fUser);
DLLEXPORT PCLibraryCategory LibraryObjects (BOOL fUser);
DLLEXPORT PCLibraryCategory LibraryEffects (BOOL fUser);
DLLEXPORT PCLibrary LibraryUserClone (PWSTR pszFile);
...
class DLLEXPORT CThumbnailCache : public CEscObject {
public:
...
class DLLEXPORT CAnimTemplate : public CAnimSocket, public CEscObject {
public:
   CAnimTemplate (void);
   ~CAnimTemplate (void);
...
class DLLEXPORT CUndoScenePacket : public CEscObject {
public:
...
to the world.
*/
class DLLEXPORT CSceneSet : public CViewSocket, public CEscObject {
public:
   CSceneSet (void);
   ~CSceneSet (void);
...
class DLLEXPORT CScene : public CEscObject {
public:
   CScene (void);
   ~CScene (void);
...
class DLLEXPORT CSceneObj : public CEscObject {
public:
   CSceneObj (void);
   ~CSceneObj (void);
...
been generated
*/
class DLLEXPORT CAnimAttrib : public CEscObject {
...
class DLLEXPORT CTimeline : public CEscObject {
...
class DLLEXPORT CSceneView : public CViewSocket, public CViewSceneSocket, public CEscObject {
...
DLLEXPORT BOOL AnimAnimate (PANIMINFO pai);
DLLEXPORT BOOL AnimAnimateWait (PANIMINFO pai);
...
class DLLEXPORT CNoise2D : public CEscObject {
public:
   CNoise2D (void);
   ~CNoise2D (void);
...
class DLLEXPORT CNoise3D : public CEscObject {
public:
   CNoise3D (void);
   ~CNoise3D (void);
...
class DLLEXPORT CGroundView : public CEscObject {
...
class DLLEXPORT CPaintView : public CEscObject {
...
public:
   ...
   CRenderTraditional m_Render;  // render engine to use
...
/******************************************************************************
CObjectClone */
class DLLEXPORT CObjectClone : private CRenderSocket, public CEscObject {
public:
   CObjectClone (void);
   ~CObjectClone (void);         // note: dont call this. call release

   BOOL Init (GUID *pgCode, GUID *pgSub);
   DWORD AddRef (void);
   DWORD Release (void);
...
DLLEXPORT PCObjectClone ObjectCloneGet (GUID *pgCode, GUID *pgSub, BOOL fCreateIfNotExist = TRUE);
...
class DLLEXPORT CForestCanopy : public CEscObject {
public:
   CForestCanopy();
   ~CForestCanopy();
   ...
   BOOL Dialog (PCEscWindow pWindow);
   fp MaxTreeSize (void);
   ...
   PCObjectClone TreeClone (DWORD dwType);
   BOOL TextureQuery (PCListFixed plText);
   BOOL ColorQuery (PCListFixed plColor);
   BOOL ObjectClassQuery (PCListFixed plObj);
...
class DLLEXPORT CForest : public CEscObject  {
public:
   CForest (void);
   ~CForest (void);
...
typedef struct {
   float                fPitch;        // frequency in Hz of original
...
class DLLEXPORT CVoiceSynthesize : public CEscObject {
public:
...
//private:
   ...
   BOOL PSOLASTRUCTContiguousExtra (PPSOLASTRUCT paPS, DWORD dwNum, fp fFormantShift,
                                             PCM3DWave pWave, fp fPhaseAngle, PCMem pMem,
   ...
   BOOL PSOLASTRUCTContiguous (PPSOLASTRUCT paPS, DWORD dwNum, fp fFormantShift,
                                             PCM3DWave pWave, fp fPhaseAngle, BOOL fSilenceToLeft, BOOL fSilenceToRight, PCMem pMem,
                                             DWORD *pdwError);
...
class DLLEXPORT CVoiceDisguise : public CEscObject {
public:
   CVoiceDisguise (void);
   ~CVoiceDisguise (void);
...
class DLLEXPORT CM3DWave : public CEscObject {
public:
   CM3DWave (void);
   ~CM3DWave (void);
   ...
   BOOL FXNoiseReduce (PCProgressSocket pProgress);
   ...
   // record
   PCM3DWave Record (HWND hWnd, DWORD *pdwReplace);
...
class DLLEXPORT CWaveView : public CEscObject {
...
class CMLexicon;
typedef CMLexicon *PCMLexicon;
class DLLEXPORT CTextParse : public CEscObject {
public:
   CTextParse (void);
   ~CTextParse (void);
...
class DLLEXPORT CNGramDatabase : public CEscObject {
public:
   CNGramDatabase (void);
   ~CNGramDatabase (void);
...
*/
class DLLEXPORT CLexParseGroup : public CEscObject {
public:
   CLexParseGroup (void);
   ~CLexParseGroup (void);
...
class DLLEXPORT CLexParseRule : public CEscObject {
public:
   CLexParseRule (void);
   ~CLexParseRule (void);
...
class DLLEXPORT CLexParseWordScratch : public CEscObject {
public:
...
class DLLEXPORT CLexParse : public CEscObject, public CEscMultiThreaded {
public:
   CLexParse (void);
   ~CLexParse (void);
...
class DLLEXPORT CMLexicon : public CEscObject {
public:
   CMLexicon (void);
   ~CMLexicon (void);
...
DLLEXPORT void MLexiconCacheShutDown (void);
...
class DLLEXPORT CVoiceFile : public CEscObject {
public:
   CVoiceFile (void);
   ~CVoiceFile (void);
   PCMMLNode2 MMLTo (void);
   ...
   BOOL TrainRecordings (HWND hWnd, BOOL fLessPickey);
   BOOL TrainSingleWave (PCM3DWave pWave, HWND hWnd, PCProgress pProgress, BOOL fLessPickey,
...
class CProgressWaveTTSToWave : public CEscObject, public CProgressWaveTTS {
public:
...
class DLLEXPORT CMTTSSubVoice : public CEscObject {
public:
   CMTTSSubVoice (void);
   ~CMTTSSubVoice (void);
...
typedef struct {
   float          afUnitScorePitch[PIS_PHONEGROUPNUM][2];
   float          afUnitScorePCMPitch[PIS_PHONEGROUPNUM][2];
   float          afUnitScorePCMPitchPSOLA[PIS_PHONEGROUPNUM][2];
   float          afUnitScoreEnergy[PIS_PHONEGROUPNUM][2];
   float          afUnitScoreDuration[PIS_PHONEGROUPNUM][2];
   float          afUnitScoreFunc[PIS_PHONEGROUPNUM];
   float          afUnitScoreMismatchedWordPos[4];
...
typedef struct {
   ...
   fp                fPitch;           // how much pitch affects, per octave
...
class DLLEXPORT CMTTS : public CEscObject, public CEscMultiThreaded {
...
public:
   ...
   // analysis
   BOOL SynthDetermineTriPhoneAudio (fp fAvgPitch, DWORD *padwPhone, DWORD *padwWord, DWORD *padwDur, fp *pafVol, BOOL fVolAbsolute, PCListVariable plPitch, DWORD dwNum,
   ...
   PCMTTSTriPhonePros SynthDetermineTriPhonePros (BYTE bPhone, WORD wWordPos,
...
//                         BOOL fCanUseLeft, BOOL fCanUseRight,
                         ...
                         BOOL fCheckForExist);
   BOOL TriPhoneProsSet (DWORD dwPhone, WORD wWordPos, BYTE bPhoneLeft, BYTE bPhoneRight,
   ...
   BOOL ProsPhoneEmph (CPoint paPhoneEmph[NUMPHONEEMPH*2][PHONEPOSBIN]);
...
private:
   ...
   DWORD SpeakNodeSubDivideText (PWSTR pszText);
...
DLLEXPORT PCMTTS TTSCacheOpen (PWSTR pszFile = NULL, BOOL fLoadIfNotExist = TRUE);
...
DLLEXPORT DWORD RecBatch (DWORD dwCalcFor, PCEscWindow pWindow, PCWSTR pszVoiceFile, BOOL fRequireVoiceFile,
                ...
                PCWSTR pszMasterFile, PCWSTR pszStartName, HWND hWnd = NULL);
...
typedef struct {
   double         afPhonemePitchSum[256];    // pitch sum per phoneme
   ...
   PCListFixed    paplTriPhone[4][PHONEGROUPSQUARE];      // triphone information
   ...
   // CPoint         apWordEmphFromWordLength[NUMPROSWORDLENGTH+1]; // amount to scale emphasis depending on word length
                                             // [0]=pitch, [1]=vol, [2]=dur
   CPoint         apPhoneEmph[NUMPHONEEMPH*2][PHONEPOSBIN]; // how much the phonemes are emphasized based on neighboring POS
                                             // first entries are left part of word, last entries are right part
                                             // the [16] is for the high nibble of the POS
...
typedef struct {
   double            afScore[4];          // score for the 4 different word positions. 0 = exact match,
                                          // 1 = mismatch in left, 2 = mismatch in right, 3 = mismatch in both
   DWORD             adwCount[4];         // count for number of entries in each
...
typedef struct {
   fp             fPitch;        // relative pitch, linear
...
typedef struct {
   ...
   double               fPitchSum;  // pitch stored as log() x count
   double               fPitchSweepSum; // sweep stored as log x count
   double               fPitchBulgeSum; // bulge stored as log x count
...
class DLLEXPORT CTTSWork : public CEscObject, public CEscMultiThreaded {
public:
   CTTSWork (void);
   ~CTTSWork (void);
   ...
   BOOL ScanCommonWords (HWND hWnd);
   DWORD Recommend (HWND hWnd);
   BOOL Analyze (HWND hWnd, PCEscWindow pWindow);
   ...
   void BlacklistClearTriPhone (PTTSANAL pAnal, WORD wPhone, WORD wWordPos, WORD wTriPhone);
   void BlacklistClearWord (PTTSANAL pAnal, DWORD dwWord);
   DWORD BlacklistNumTriPhone (PTTSANAL pAnal, WORD wPhone, WORD wWordPos,
   ...
   BOOL AnalysisWord (PTTSANAL pAnal, PCMTTS PTTS, DWORD dwWord, BOOL fRemoveExisting,
      BOOL fNow);
#endif
   BOOL AnalysisTriPhone (PTTSANAL pAnal, PCMTTS pTTS, DWORD dwPhone, WORD wWOrdPos,
                                 WORD wTriPhone, BOOL fRemoveExisting, BOOL fNow);

   BOOL DialogMain (PCEscWindow pWindow);
   BOOL ResegmentWaves (PCEscPage pPage, DWORD dwMode, BOOL fKeepExisting, BOOL fJustFeatures /* = FALSE*/,
      PCVoiceFile pVF);
...
class DLLEXPORT CTTSTransPros : public CEscObject {
public:
   CTTSTransPros (void);
   ~CTTSTransPros (void);
...
class DLLEXPORT CNPREffectOutline : public CNPREffect, public CEscObject {
public:
...
class DLLEXPORT CNPREffectFog : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
   CNPREffectFog (void);
   ~CNPREffectFog (void);
...
class DLLEXPORT CNPREffectFogHLS : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
...
class DLLEXPORT CNPREffectColor : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
...
class DLLEXPORT CNPREffectAutoExposure : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
...
class DLLEXPORT CNPREffectColorBlind : public CNPREffect, public CEscObject {
public:
...
class DLLEXPORT CNPREffectPosterize : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
...
class DLLEXPORT CNPREffectHalftone : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
...
class DLLEXPORT CNPREffectFilmGrain : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
...
class DLLEXPORT CNPREffectWatercolor : public CNPREffect, public CEscObject {
public:
...
class DLLEXPORT CNPREffectTV : public CNPREffect, public CEscObject {
public:
   CNPREffectTV (void);
   ~CNPREffectTV (void);
...
class DLLEXPORT CNPREffectBlur : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
   CNPREffectBlur (void);
   ~CNPREffectBlur (void);
...
class DLLEXPORT CNPREffectDOF : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
   CNPREffectDOF (void);
   ~CNPREffectDOF (void);
...
class DLLEXPORT CNPREffectGlow : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
   CNPREffectGlow (void);
   ~CNPREffectGlow (void);
...
class DLLEXPORT CNPREffectSpyglass : public CNPREffect, public CEscObject {
public:
...
class DLLEXPORT CNPREffectRelief : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
...
class DLLEXPORT CNPREffectPainting : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
...
class DLLEXPORT CNPREffectOutlineSketch : public CNPREffect, public CEscMultiThreaded, public CEscObject {
public:
...
/*********************************************************************************
CNPREffectsList */
class DLLEXPORT CNPREffectsList : public CEscObject {
public:
...
/***********************************************************************************
Effects */
DLLEXPORT void EffectEnumMajor (PCListFixed pl);
DLLEXPORT void EffectEnumMinor (PCListFixed pl, PWSTR pszMajor);
DLLEXPORT void EffectEnumItems (PCListFixed pl, PWSTR pszMajor, PWSTR pszMinor);
DLLEXPORT BOOL EffectGUIDsFromName (PWSTR pszMajor, PWSTR pszMinor, PWSTR pszName, GUID *pgCode, GUID *pgSub);
DLLEXPORT BOOL EffectNameFromGUIDs (GUID *pgCode, GUID *pgSub,PWSTR pszMajor, PWSTR pszMinor, PWSTR pszName);
DLLEXPORT BOOL EffectLibraryDialog (HWND hWnd, PCImage pImage, PCRenderSuper pRender,
                          PCWorldSocket pWorld);
DLLEXPORT PCNPREffectsList EffectCreate (const GUID *pCode, const GUID *pSub);
DLLEXPORT BOOL EffectSelDialog (HWND hWnd, GUID *pgEffectCode, GUID *pgEffectSub);
DLLEXPORT HBITMAP EffectGetThumbnail (GUID *pgCode, GUID *pgSub, HWND hWnd, COLORREF *pcTransparent = NULL,
