...
SampleTtsEngine\SampleTtsEngine.rc      Resource scritps.
...
MakeVoice\MakeVoice.rc                  Resource scritps.
...
To build the sample using Visual Studio 2005:
=============================================
    1. Open Windows Explorer and navigate to the directory.
    2. On Windows XP, double-click the icon for the SampleTtsEngine.sln
       (solution) file to open the file in Visual Studio. On Windows Vista run
       the Visual Studio 2005 as administrator by right clicking the Visual
       Studio icon and selecting "Run as administrator". Then open the solution
       file from the "File -> Open -> Project/Solution" menu.
...
There are various ways to see the sample engine running:
    ...
    3. On Windows Vista, go to the "Control Panel -> Ease of Access -> Speech
